...
#define HDPATH_1_DEFAULT     (0x80000000u | 0x178u)
...
#define MENU_MAIN_APP_LINE1                "MXW"
#define MENU_MAIN_APP_LINE2                "Ready"
#define APPVERSION_LINE1                   "Version:"
#define APPVERSION_LINE2                   ("v" APPVERSION)

#define COIN_DEFAULT_CHAINID                "maxonrow"

// In non-expert mode, the app will convert from uatom to ATOM
#define COIN_DEFAULT_DENOM_BASE             "cin"
#define COIN_DEFAULT_DENOM_REPR             "MXW"
#define COIN_DEFAULT_DENOM_FACTOR           18
#define COIN_DEFAULT_DENOM_TRIMMING         18
